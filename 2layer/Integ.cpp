...
double Simpson_integ7 (int n_steps, double a, double b, double (*func)( double t, int i, int nn, double x[], double w[], double Nmb[], double Beta, double dBeta[], int injectionmode, double R, double alpha), int i, int nn, double x[], double w[], double Nmb[], double Beta, double dBeta[], int injectionmode, double R, double alpha)
{
    int n;
    double sum=0;
    double tk=0., dt;
    ...
    {
        tk=a+n*dt;
        f1=(*func)(tk,i,nn,x,w,Nmb,Beta,dBeta,injectionmode,R,alpha);
        f2=(*func)(tk+dt/2,i,nn,x,w,Nmb,Beta,dBeta,injectionmode,R,alpha);
        f3=(*func)(tk+dt,i,nn,x,w,Nmb,Beta,dBeta,injectionmode,R,alpha);
        sum+=dt*(f1+4*f2+f3)/6;/*simpson f-la for Ik*/
    }
...
double Simpson_integ10 (int n_steps, double a, double b, double (*func)( double t, double x, double xp, int xpp, double alpha), double x, double xp, int xpp, double alpha)
{
    int n;
    double sum=0;
    double tk=0., dt;
    ...
    { 
      tk=a+n*dt;
      f1=(*func)(tk,x, xp, xpp, alpha);
      f2=(*func)(tk+dt/2., x, xp, xpp, alpha);
      f3=(*func)(tk+dt, x, xp, xpp, alpha);
      sum+=dt*(f1+4*f2+f3)/6.; 
    }
